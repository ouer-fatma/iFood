 ...
 */
final class Version20220507173149 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE plate (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, description VARCHAR(200) NOT NULL, name VARCHAR(200) NOT NULL, price BIGINT NOT NULL, quantity INT NOT NULL, INDEX IDX_719ED75B12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE pack_line');
        $this->addSql('DROP TABLE plate');
        $this->addSql('DROP TABLE plate_category');
